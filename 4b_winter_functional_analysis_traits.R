...
ggsave('winter_avTD_boxplot.png', plot = p1, height = 4, width = 4, dpi = 300, bg = "white")
...
p1_s
ggsave("winter_avtd.png", plot = p1_w, width = 6, height = 8, units = "in", dpi = 300)
...
ggsave('average_functional_diversity', plot = avFD_boxplot, height = 4, width = 4, dpi = 300, bg = "white")
...
ggsave('rao_functional_diversity', plot = p3, height = 4, width = 4, dpi = 300, bg = "white")
...
ggsave('redundancy_functional_diversity', plot = p4, height = 4, width = 4, dpi = 300, bg = "white")
...
plot_layout(ncol = 3)
combined_plot
ggsave('combined_winter.png', plot = combined_plot, height = 4, width = 16, dpi = 300, bg = "white")
