...
This analysis is split into two sets, one with all trophic niches included and one
with aquatic nices excluded to test the differences of non-aquatic species.
(6_biomass_comparison_nowetland)
...
print(summer_w_overall_average) #218
...
print(summer_n_overall_average) # 43.6
...
print(winter_w_overall_average) # 191 kg
...
print(winter_n_overall_average) # 57.8
